...
There are two ways to host your bot on node.gg:

---

Method 1: Discord Server

Steps on How to Host:

1. Open a Ticket

Open a ticket in the support channel in our server. Staff will ask you questions. Answer them.

2. Give Your GitHub Repo

Provide your GitHub repository link. Absolutely do not hardcode or paste the token in your code. Set it in GitHub Actions and Secrets.

3. Wait for the Magic

The bot will be online and you will be told in your ticket.
